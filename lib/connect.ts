...
export async function connect (config: IKitConfig, authWindow: AuthWindow, connector: Connector): Promise<Connection> {
...
export async function reconnect (config: IKitConfig, authWindow: AuthWindow, connection: Connection): Promise<Connection> {
